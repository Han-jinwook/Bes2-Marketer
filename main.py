...
with st.sidebar:
    ...
    strategy_options = {
        "🦖 올드보이 발굴 (6개월~1년)": {"days": 365, "min_rel": 80, "desc": "오래된 영상 중 내용이 충실한 곳(80점+) 공략"},
        "⚽ 미드필더 장악 (1~6개월)": {"days": 180, "min_rel": 70, "desc": "검색 유입이 살아있는 구간 공략 (70점+)"},
        "⭐ 라이징 스타 (최근 1개월)": {"days": 30, "min_rel": 60, "desc": "최근 떠오르는 핫한 영상 선점 (60점+)"},
        "☕ 데일리 루틴 (최근 24시간)": {"days": 1, "min_rel": 50, "desc": "매일 아침 가볍게 돌리는 루틴 (50점+)"}
    }
